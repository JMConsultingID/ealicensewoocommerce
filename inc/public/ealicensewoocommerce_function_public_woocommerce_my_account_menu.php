            ...
            menuItems.forEach(function(item) {
                ...
                if (!item.querySelector('i') && !item.querySelector('svg')) {
                    if (item.innerText.includes("Expert Advisor")) {
                        ...
                        item.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M16.25 11.875V9.6875C16.25 8.1342 14.9908 6.875 13.4375 6.875H12.1875C11.6697 6.875 11.25 6.45527 11.25 5.9375V4.6875C11.25 3.1342 9.9908 1.875 8.4375 1.875H6.875M8.75 1.875H4.6875C4.16973 1.875 3.75 2.29473 3.75 2.8125V17.1875C3.75 17.7053 4.16973 18.125 4.6875 18.125H15.3125C15.8303 18.125 16.25 17.7053 16.25 17.1875V9.375C16.25 5.23286 12.8921 1.875 8.75 1.875Z" stroke="#09CA8C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> ' + item.innerHTML;
